...
////////////////////////////////////////////////////////////////////////////////
/////////// OPTIONAL PART 4: WINDOW FUNCTION FOR DISTANCE ATTENUATION //////////
////////////////////////////////////////////////////////////////////////////////
...
float dmax = 3.0; // max distance for attenuation window function
...
vec3 shade(){
	...
	float fwin = pow(max(1 - pow(d/dmax,4.0),0.0),2.0);
	float fdist = (d0 / (d*d + epsilon)) * fwin;
